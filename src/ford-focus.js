...
export class FordFocus extends LitElement {
  ...
  constructor() {
    ...
    this.paragraph2 = 'Varía según la generación y el modelo específico, típicamente entre 1.0 y 2.3 litros.    '

    this.title3 = 'Potencia del motor:     '
    this.paragraph3 = 'Entre 123 y 350 hp (91-261 kW).    '

    this.title4 = 'Torque del motor:     '
    this.paragraph4 = 'Entre 125 y 350 lb-pie (169-475 Nm).    '
    ...
    this.paragraph8 = 'Aproximadamente 13-23 pies cúbicos en el maletero.    '

    this.title9 = 'Capacidad de remolque:  '
    this.paragraph9 = 'No diseñado para remolcar.  '

    this.title10 = 'Funcionalidades especiales:  '
    this.paragraph10 = 'Características de seguridad avanzadas, sistemas de infoentretenimiento y asistencia al conductor.   '

    this.imageURL = 'https://hips.hearstapps.com/hmg-prod/images/focus-st-edition-004-1629818858.jpg?crop=0.9998222222222223xw:1xh;center,top&resize=1200:*  '
  }
...
window.customElements.define('ford-focus', FordFocus)
